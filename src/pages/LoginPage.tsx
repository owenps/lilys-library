...
export function LoginPage() {
  ...
  // Temporarily apply default theme visually without changing localStorage
  useEffect(() => {
    ...
    return () => {
      // Restore theme classes when leaving login page
      activeClasses.forEach((cls) => root.classList.add(cls));
    };
  }, []);
